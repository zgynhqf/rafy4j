...
public class TypesSearcher {
     ...
     * @return 该包下的class
     */
    private static void getClasses(String packageName, Set<Class<?>> classes) {
        // 是否循环迭代
        ...
        try {
            ...
            while (dirs.hasMoreElements()) {
                ...
                if ("file".equals(protocol)) {
                    ...
                    findAndAddClassesInPackageByFile(packageName, filePath, recursive, classLoader, classes);
    ...
    private static void findAndAddClassesInPackageByFile(
        ...
        for (File file : dirfiles) {
            // 如果是目录 则继续扫描
            if (file.isDirectory()) {
                findAndAddClassesInPackageByFile(packageName + "." + file.getName(), file.getAbsolutePath(), recursive, classLoader, classes);
            } else {
